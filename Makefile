...
SRCS_NAME = main.c ft_split_tokens.c error_handle.c  init.c echo.c  tokenisation.c ft_itoa.c utils.c word_count.c dollar.c utils2.c free.c quotes.c ft_split.c commands.c pipex.c  here_doc.c
